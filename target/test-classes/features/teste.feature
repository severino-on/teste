...
Funcionalidade: test api
  ...
  Cenario: test api
    ...
    Quando preencho o campo "nome" com "Bill" do objeto json
    ...
    Entao valido o campo "nome" com o valor "Bill"
  ...
  Esquema do Cenario: <cenario>
    ...
    Exemplos: 
      ...
      | teste Bill     | Bill     |    31 | rg   | 5421542121 | cpf               |   548755421 | Bill         | rg           | cpf               |
